...
namespace PackageThis
{
    class HxS : ICompilable
    {
        ...
        static private Stream resourceStream = typeof(AppController).Assembly.GetManifestResourceStream("PackageThis.Extra.hxs.xslt");
        ...
        {
            using (Stream resourceStream = typeof(Program).Assembly.GetManifestResourceStream("PackageThis.Extra." + filename))
            {
